...
public class BaseGestureDetector {
     ...
     */
    @Deprecated
    public BaseGestureDetector(OnGestureListener listener, Handler handler) {
     ...
     */
    @Deprecated
    public BaseGestureDetector(OnGestureListener listener) {
     ...
     * @throws NullPointerException if {@code listener} is null.
     */
    public BaseGestureDetector(Context context, OnGestureListener listener) {
     ...
     * @throws NullPointerException if {@code listener} is null.
     */
    public BaseGestureDetector(Context context, OnGestureListener listener, Handler handler) {
        if (handler != null) {
