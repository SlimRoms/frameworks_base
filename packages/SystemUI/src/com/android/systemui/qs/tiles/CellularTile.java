...
public class CellularTile extends QSTile<QSTile.SignalState> {
    ...
    private final NetworkController mDataController;
    ...
    public CellularTile(Host host) {
        super(host);
        mDataController = host.getNetworkController();
        mDataController = mDataController.getMobileDataController();
    ...
    public void setListening(boolean listening) {
        if (listening) {
            mDataController.addNetworkSignalChangedCallback(mCallback);
        } else {
            mDataController.removeNetworkSignalChangedCallback(mCallback);
        }
    }
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        state.visible = mDataController.hasMobileDataFeature();
