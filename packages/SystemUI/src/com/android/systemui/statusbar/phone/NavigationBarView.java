...
public class NavigationBarView extends LinearLayout {
    ...
    protected final static boolean SLIPPERY_WHEN_DISABLED = true;
    ...
    protected Drawable mHomeIcon, mHomeLandIcon;
    ...
    protected final NavTransitionListener mTransitionListener = new NavTransitionListener();
    ...
    protected class NavTransitionListener implements TransitionListener {
    ...
    protected final OnClickListener mImeSwitcherClickListener = new OnClickListener() {
        @Override
    ...
    protected void updateTaskSwitchHelper() {
