...
public class HeadsUpNotificationView extends LinearLayout implements SwipeHelper.Callback, ExpandHelper.Callback,
    ...
    public void updateResources() {
        ...
        if (mBelowContentContainer != null) {
            final FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) mBelowContentContainer.getLayoutParams();
            lp.width = width;
            lp.gravity = gravity;
            mBelowContentContainer.setLayoutParams(lp);
        }
        if (mContentHolder != null) {
            final LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mContentHolder.getLayoutParams();
            lp.width = width;
            lp.gravity = gravity;
    ...
    public boolean showNotification(NotificationData.Entry headsUp) {
        ...
        if (mHeadsUp != null) {
            ...
            if (mBelowContentContainer != null) {
                int snoozeMargin = mHeadsUp.row.getHeight() - (mBelowContentContainer.getHeight() / 2);
                FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) mBelowContentContainer.getLayoutParams();
