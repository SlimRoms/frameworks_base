...
public class TunerFragment extends PreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStatusBarBatteryPercent.setSummary(mStatusBarBatteryShowPercent.getEntry());
    ...
    private void updateBatteryPercentPreference(String value) {
        mStatusBarBatteryPercent.setEnabled(!(value.equals(STATUS_BAR_BATTERY_STYLE_TEXT)
