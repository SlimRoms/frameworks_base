...
import com.android.systemui.quicksettings.ShortcutPickHelper.AppExpandableAdapter.GroupInfo;
...
public class ShortcutPickHelper {
    ...
    private void startFragmentOrActivity(Intent pickIntent, int requestCode) {
        if (mLastFragmentId == 0) {
            ...
            Fragment cFrag = mParent.getFragmentManager().findFragmentById(mLastFragmentId);
            if (cFrag != null) {
    ...
    public class AppExpandableAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
            ...
            textView.setText(getChild(groupPosition, childPosition)
                .replaceFirst(allList.get(groupPosition).info.packageName + ".", ""));
            return convertView;
        }
    ...
    private static String getFriendlyActivityName(Intent intent, boolean labelOnly) {
    ...
    private static String getFriendlyShortcutName(Intent intent) {
    ...
    public static String getFriendlyNameForUri(String uri) {
        if (uri == null) {
            return null;
        }
