...
public class CreateShortcut extends LauncherActivity {
    ...
    private boolean mExistsAsSetting;
    private boolean mExistsAsSlimSetting;
    ...
    private void updateSettingType(String value) {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            mSlimSettingType = SLIM_SECURE_FLOAT;
                                        } catch (SlimSettingNotFoundException f) {
                                            mExistsAsSlimSetting = false;
                                        }
                                    }
                                }
                            }
        ...
        Log.d(TAG, "updateSettingType()" + " value:" + value
                + " mSettingType:" + mSettingType + " mExistsAsSetting:" + (mExistsAsSetting ? "true" : "false")
                + " mSlimSettingType:" + mSlimSettingType + " mExistsAsSlimSetting:" + (mExistsAsSlimSetting ? "true" : "false"));
    }
            ...
            case DLG_SECRET:
                ...
                .setPositiveButton(R.string.dlg_ok,
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        boolean resultOk = mExistsAsSetting || mExistsAsSlimSetting;

                        if (mExistsAsSetting && mExistsAsSlimSetting) {
                            // if setting exists in both providers, prompt user for decision
                            showDialogSetting(DLG_SECRET_SLIM);
                        } else if (mExistsAsSlimSetting && !mExistsAsSetting) {
