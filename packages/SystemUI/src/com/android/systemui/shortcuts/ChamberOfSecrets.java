/*
 * Copyright 2013-2015 SlimRom - Jubakuba
 *
...
public class ChamberOfSecrets extends Activity  {
    ...
    private static final int SYSTEM_INT = 1;
    private static final int SECURE_INT = 2;
    private static final int SYSTEM_LONG = 3;
    private static final int SECURE_LONG = 4;
    private static final int SYSTEM_FLOAT = 5;
    private static final int SECURE_FLOAT = 6;
    private static final int GLOBAL_INT = 7;
    private static final int GLOBAL_LONG = 8;
    private static final int GLOBAL_FLOAT = 9;

    private static final int SLIM_SYSTEM_INT = 10;
    private static final int SLIM_SECURE_INT = 11;
    private static final int SLIM_SYSTEM_LONG = 12;
    private static final int SLIM_SECURE_LONG = 13;
    private static final int SLIM_SYSTEM_FLOAT = 14;
    private static final int SLIM_SECURE_FLOAT = 15;
    private static final int SLIM_GLOBAL_INT = 16;
    private static final int SLIM_GLOBAL_LONG = 17;
    private static final int SLIM_GLOBAL_FLOAT = 18;
            ...
            if (setting != null && array != null) {
                switch (type) {
                    ...
                    case SLIM_SYSTEM_INT:
                        current= SlimSettings.System.getIntForUser(getContentResolver(),
                                setting, 0, UserHandle.USER_CURRENT);
                        SlimSettings.System.putInt(getContentResolver(),
                                setting, getNewInt(array, current));
                        break;
                    case SLIM_SECURE_INT:
                        current = SlimSettings.Secure.getIntForUser(getContentResolver(),
                                setting, 0, UserHandle.USER_CURRENT);
                    ...
                    case SLIM_GLOBAL_INT:
                        current = SlimSettings.Global.getInt(getContentResolver(),
                                setting, 0);
