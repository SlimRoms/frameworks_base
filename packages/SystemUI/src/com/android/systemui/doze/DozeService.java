...
public class DozeService extends DreamService {
    ...
    public void onCreate() {
        ...
        mHandWaveSensor = new TriggerSensor(Sensor.TYPE_WAKE_GESTURE,
                mDozeParameters.getPulseOnHandWave(), mDozeParameters.getVibrateOnHandWave(),
                DozeLog.PULSE_REASON_WAKE_GESTURE);
        mPocketSensor = new TriggerSensor(Sensor.TYPE_WAKE_GESTURE,
    ...
    private void requestPulse(final int reason) {
        if (mHost != null && mDreaming && !mPulsing) {
            ...
            final boolean isHandWave = reason == DozeLog.PULSE_REASON_WAKE_GESTURE
                        && mDozeParameters.getPulseOnHandWave();
            final boolean isPocket = reason == DozeLog.PULSE_REASON_WAKE_GESTURE
