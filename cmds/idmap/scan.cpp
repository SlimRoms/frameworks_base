...
namespace {
    ...
    int idmap_scan(const char *target_package_name,
            ...
            SortedVector<Overlay>& overlayVector, const android::Vector<const char *> *overlay_dirs)
    {
        ...
        for (size_t i = 0; i < N; ++i) {
            ...
            while ((dirent = readdir(dir)) != NULL) {
                ...
                if (S_ISDIR(st.st_mode)) {
                    ...
                    android::Vector<const char *> overlay_path;
                    overlay_path.push(overlay_apk_path);
                    idmap_scan(target_package_name, target_apk_path, idmap_dir,
                            overlayVector, &overlay_path);
                } else {
        ...
        const char *idmap_dir, const android::Vector<const char *> *overlay_dirs)
{
    ...
    int res = idmap_scan(target_package_name, target_apk_path, idmap_dir,
            overlayVector, overlay_dirs);
