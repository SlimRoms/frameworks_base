...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mNavigationBarHeightForRotation[mSeascapeRotation] = SlimSettings.System.getIntForUser(
            ...
            mNavigationBarWidthForRotation[mSeascapeRotation] = SlimSettings.System.getIntForUser(
                        mContext.getContentResolver(),
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        boolean useHapticFeedback = down
                ...
                && event.getRepeatCount() == 0
                && (mHardwareKeyHandler != null &&
                        !mHardwareKeyHandler.shouldDisableHapticFeedback(keyCode));
